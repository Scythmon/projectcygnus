package net.scythmon.cygnus.screen;
...
import net.scythmon.cygnus.block.entity.StarForgeBlockEntity;
...
public class StarForgeMenu extends AbstractContainerMenu {
    ...
    public StarForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.STAR_FORGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((StarForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.STAR_FORGE.get());
    }
